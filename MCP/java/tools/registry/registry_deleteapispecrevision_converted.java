/**
 * MCP Server function for DeleteApiSpecRevision deletes a revision of a spec.
 */
...
class Delete_V1_Projects_Project_Locations_Location_Apis_Api_Versions_Version_Specs_Spec_Delete_RevisionMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getDelete_V1_Projects_Project_Locations_Location_Apis_Api_Versions_Version_Specs_Spec_Delete_RevisionHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("spec")) {
            queryParams.add("spec=" + args.get("spec"));
                ...
                String url = config.getBaseUrl() + "/api/v2/delete_v1_projects_project_locations_location_apis_api_versions_version_specs_spec_delete_revision" + queryString;
    ...
    public static MCPServer.Tool createDelete_V1_Projects_Project_Locations_Location_Apis_Api_Versions_Version_Specs_Spec_Delete_RevisionTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "delete_v1_projects_project_locations_location_apis_api_versions_version_specs_spec_delete_revision",
            "DeleteApiSpecRevision deletes a revision of a spec.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getDelete_V1_Projects_Project_Locations_Location_Apis_Api_Versions_Version_Specs_Spec_Delete_RevisionHandler(config));
    }
