/**
 * MCP Server function for ListApiSpecRevisions lists all revisions of a spec.
...
class Get_V1_Projects_Project_Locations_Location_Apis_Api_Versions_Version_Specs_Spec_List_RevisionsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_V1_Projects_Project_Locations_Location_Apis_Api_Versions_Version_Specs_Spec_List_RevisionsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("pageSize")) {
            queryParams.add("pageSize=" + args.get("pageSize"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_v1_projects_project_locations_location_apis_api_versions_version_specs_spec_list_revisions" + queryString;
    ...
    public static MCPServer.Tool createGet_V1_Projects_Project_Locations_Location_Apis_Api_Versions_Version_Specs_Spec_List_RevisionsTool(MCPServer.APIConfig config) {
        ...
        pageTokenProperty.put("description", "The page token, received from a previous ListApiSpecRevisions call. Provide this to retrieve the subsequent page.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_v1_projects_project_locations_location_apis_api_versions_version_specs_spec_list_revisions",
            "ListApiSpecRevisions lists all revisions of a spec.
 Revisions are returned in descending order of revision creation time.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_V1_Projects_Project_Locations_Location_Apis_Api_Versions_Version_Specs_Spec_List_RevisionsHandler(config));
    }
