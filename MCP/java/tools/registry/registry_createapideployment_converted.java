/**
 * MCP Server function for CreateApiDeployment creates a specified deployment.
 */
...
class Post_V1_Projects_Project_Locations_Location_Apis_Api_DeploymentsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_V1_Projects_Project_Locations_Location_Apis_Api_DeploymentsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("apiDeploymentId")) {
            queryParams.add("apiDeploymentId=" + args.get("apiDeploymentId"));
        }
        ...
        if (args.containsKey("labels")) {
            queryParams.add("labels=" + args.get("labels"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_v1_projects_project_locations_location_apis_api_deployments" + queryString;
    ...
    public static MCPServer.Tool createPost_V1_Projects_Project_Locations_Location_Apis_Api_DeploymentsTool(MCPServer.APIConfig config) {
        ...
        Map<String, Object> apiDeploymentIdProperty = new HashMap<>();
        apiDeploymentIdProperty.put("type", "string");
        apiDeploymentIdProperty.put("required", false);
        apiDeploymentIdProperty.put("description", "Required. The ID to use for the deployment, which will become the final component of the deployment's resource name. This value should be 4-63 characters, and valid characters are /[a-z][0-9]-/. Following AIP-162, IDs must not have the form of a UUID.");
        properties.put("apiDeploymentId", apiDeploymentIdProperty);
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_v1_projects_project_locations_location_apis_api_deployments",
            "CreateApiDeployment creates a specified deployment.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_V1_Projects_Project_Locations_Location_Apis_Api_DeploymentsHandler(config));
    }
