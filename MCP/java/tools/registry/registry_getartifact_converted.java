/**
 * MCP Server function for GetArtifact returns a specified artifact.
 */
...
class Get_V1_Projects_Project_Locations_Location_Artifacts_ArtifactMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_V1_Projects_Project_Locations_Location_Artifacts_ArtifactHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("artifact")) {
            queryParams.add("artifact=" + args.get("artifact"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_v1_projects_project_locations_location_artifacts_artifact" + queryString;
    ...
    public static MCPServer.Tool createGet_V1_Projects_Project_Locations_Location_Artifacts_ArtifactTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_v1_projects_project_locations_location_artifacts_artifact",
            "GetArtifact returns a specified artifact.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_V1_Projects_Project_Locations_Location_Artifacts_ArtifactHandler(config));
    }
