/**
 * MCP Server function for GetApiDeployment returns a specified deployment.
 */
...
class Get_V1_Projects_Project_Locations_Location_Apis_Api_Deployments_DeploymentMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_V1_Projects_Project_Locations_Location_Apis_Api_Deployments_DeploymentHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("deployment")) {
            queryParams.add("deployment=" + args.get("deployment"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_v1_projects_project_locations_location_apis_api_deployments_deployment" + queryString;
    ...
    public static MCPServer.Tool createGet_V1_Projects_Project_Locations_Location_Apis_Api_Deployments_DeploymentTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_v1_projects_project_locations_location_apis_api_deployments_deployment",
            "GetApiDeployment returns a specified deployment.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_V1_Projects_Project_Locations_Location_Apis_Api_Deployments_DeploymentHandler(config));
    }
