/**
 * MCP Server function for DeleteApiVersion removes a specified version and all of the resources that
 it owns.
 */
...
class Delete_V1_Projects_Project_Locations_Location_Apis_Api_Versions_VersionMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getDelete_V1_Projects_Project_Locations_Location_Apis_Api_Versions_VersionHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("force")) {
            queryParams.add("force=" + args.get("force"));
                ...
                String url = config.getBaseUrl() + "/api/v2/delete_v1_projects_project_locations_location_apis_api_versions_version" + queryString;
    ...
    public static MCPServer.Tool createDelete_V1_Projects_Project_Locations_Location_Apis_Api_Versions_VersionTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "delete_v1_projects_project_locations_location_apis_api_versions_version",
            "DeleteApiVersion removes a specified version and all of the resources that
 it owns.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getDelete_V1_Projects_Project_Locations_Location_Apis_Api_Versions_VersionHandler(config));
    }
