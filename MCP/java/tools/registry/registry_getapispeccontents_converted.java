/**
 * MCP Server function for GetApiSpecContents returns the contents of a specified spec.
...
class Get_V1_Projects_Project_Locations_Location_Apis_Api_Versions_Version_Specs_Spec_Get_ContentsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_V1_Projects_Project_Locations_Location_Apis_Api_Versions_Version_Specs_Spec_Get_ContentsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("spec")) {
            queryParams.add("spec=" + args.get("spec"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_v1_projects_project_locations_location_apis_api_versions_version_specs_spec_get_contents" + queryString;
    ...
    public static MCPServer.Tool createGet_V1_Projects_Project_Locations_Location_Apis_Api_Versions_Version_Specs_Spec_Get_ContentsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_v1_projects_project_locations_location_apis_api_versions_version_specs_spec_get_contents",
 ...
 indicates the exact format returned).",
        ...
        return new MCPServer.Tool(definition, getGet_V1_Projects_Project_Locations_Location_Apis_Api_Versions_Version_Specs_Spec_Get_ContentsHandler(config));
    }
