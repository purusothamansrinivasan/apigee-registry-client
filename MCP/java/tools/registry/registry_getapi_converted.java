/**
 * MCP Server function for GetApi returns a specified API.
 */
...
class Get_V1_Projects_Project_Locations_Location_Apis_ApiMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_V1_Projects_Project_Locations_Location_Apis_ApiHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("api")) {
            queryParams.add("api=" + args.get("api"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_v1_projects_project_locations_location_apis_api" + queryString;
    ...
    public static MCPServer.Tool createGet_V1_Projects_Project_Locations_Location_Apis_ApiTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_v1_projects_project_locations_location_apis_api",
            "GetApi returns a specified API.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_V1_Projects_Project_Locations_Location_Apis_ApiHandler(config));
    }
