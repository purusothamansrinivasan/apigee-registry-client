/**
 * MCP Server function for ReplaceArtifact can be used to replace a specified artifact.
 */
...
class Put_V1_Projects_Project_Locations_Location_Artifacts_ArtifactMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPut_V1_Projects_Project_Locations_Location_Artifacts_ArtifactHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("sizeBytes")) {
            queryParams.add("sizeBytes=" + args.get("sizeBytes"));
                ...
                String url = config.getBaseUrl() + "/api/v2/put_v1_projects_project_locations_location_artifacts_artifact" + queryString;
    ...
    public static MCPServer.Tool createPut_V1_Projects_Project_Locations_Location_Artifacts_ArtifactTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "put_v1_projects_project_locations_location_artifacts_artifact",
            "ReplaceArtifact can be used to replace a specified artifact.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPut_V1_Projects_Project_Locations_Location_Artifacts_ArtifactHandler(config));
    }
