/**
 * MCP Server function for UpdateApiVersion can be used to modify a specified version.
 */
...
class Patch_V1_Projects_Project_Locations_Location_Apis_Api_Versions_VersionMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_V1_Projects_Project_Locations_Location_Apis_Api_Versions_VersionHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("annotations")) {
            queryParams.add("annotations=" + args.get("annotations"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_v1_projects_project_locations_location_apis_api_versions_version" + queryString;
    ...
    public static MCPServer.Tool createPatch_V1_Projects_Project_Locations_Location_Apis_Api_Versions_VersionTool(MCPServer.APIConfig config) {
        ...
        allowMissingProperty.put("description", "If set to true, and the version is not found, a new version will be created. In this situation, `update_mask` is ignored.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "patch_v1_projects_project_locations_location_apis_api_versions_version",
            "UpdateApiVersion can be used to modify a specified version.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPatch_V1_Projects_Project_Locations_Location_Apis_Api_Versions_VersionHandler(config));
    }
