/**
 * MCP Server function for DeleteApiDeployment removes a specified deployment, all revisions, and all
...
class Delete_V1_Projects_Project_Locations_Location_Apis_Api_Deployments_DeploymentMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getDelete_V1_Projects_Project_Locations_Location_Apis_Api_Deployments_DeploymentHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("force")) {
            queryParams.add("force=" + args.get("force"));
                ...
                String url = config.getBaseUrl() + "/api/v2/delete_v1_projects_project_locations_location_apis_api_deployments_deployment" + queryString;
    ...
    public static MCPServer.Tool createDelete_V1_Projects_Project_Locations_Location_Apis_Api_Deployments_DeploymentTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "delete_v1_projects_project_locations_location_apis_api_deployments_deployment",
            "DeleteApiDeployment removes a specified deployment, all revisions, and all
 child resources (e.g. artifacts).",
            parameters
        );
        
        return new MCPServer.Tool(definition, getDelete_V1_Projects_Project_Locations_Location_Apis_Api_Deployments_DeploymentHandler(config));
    }
